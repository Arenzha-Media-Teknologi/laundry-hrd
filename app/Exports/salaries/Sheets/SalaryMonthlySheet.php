...
class SalaryMonthlySheet implements FromView, WithTitle, ShouldAutoSize, WithEvents
{
    protected $company;
    protected $employees;
    ...
    public function __construct($company, $employees)
    {
    ...
    public function view(): View
    {
        ...
        return view('payrolls.exports.reports.monthly', [

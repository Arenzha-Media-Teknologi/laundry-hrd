...
class DepartmentPolicy
{
    ...
    public function view(Credential $credential)
    {
        ...
        return in_array('view_department', $permissions);
    }
    ...
    public function create(Credential $credential)
    {
        $groupPermissions = $credential->group->permissions ?? "[]";
        $permissions = json_decode($groupPermissions);
        return in_array('add_department', $permissions);
    }
    ...
    public function update(Credential $credential)
    {
        $groupPermissions = $credential->group->permissions ?? "[]";
        $permissions = json_decode($groupPermissions);
        return in_array('edit_department', $permissions);
    }
    ...
    public function delete(Credential $credential)
    {
        $groupPermissions = $credential->group->permissions ?? "[]";
        $permissions = json_decode($groupPermissions);
        return in_array('delete_department', $permissions);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(Credential $credential, Department $department)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(Credential $credential, Department $department)
    {
        //
    }
}

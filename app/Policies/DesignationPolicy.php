...
class DesignationPolicy
{
    ...
    public function view(Credential $credential)
    {
        ...
        return in_array('view_designation', $permissions);
    }
    ...
    public function create(Credential $credential)
    {
        $groupPermissions = $credential->group->permissions ?? "[]";
        $permissions = json_decode($groupPermissions);
        return in_array('add_designation', $permissions);
    }
    ...
    public function update(Credential $credential)
    {
        $groupPermissions = $credential->group->permissions ?? "[]";
        $permissions = json_decode($groupPermissions);
        return in_array('edit_designation', $permissions);
    }
    ...
    public function delete(Credential $credential)
    {
        $groupPermissions = $credential->group->permissions ?? "[]";
        $permissions = json_decode($groupPermissions);
        return in_array('delete_designation', $permissions);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(Credential $credential, Designation $designation)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(Credential $credential, Designation $designation)
    {
        //
    }
}

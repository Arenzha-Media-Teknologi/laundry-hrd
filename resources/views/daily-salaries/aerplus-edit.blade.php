    ...
    <div class="card mb-5 mb-xxl-10">
        <div class="card-body p-lg-20">
            ...
            <div class="text-end mb-10">
                <button type="button" :data-kt-indicator="loading ? 'on' : null" class="btn btn-primary" @click="save">
                    <span class="indicator-label"><i class="bi bi-save"></i> Simpan Perubahan</span>
                ...
                <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                    ...
                    <div class="mt-n1">
                        ...
                        <div class="d-flex justify-content-between align-items-center pb-10">
                            ...
                            <!--end::Logo-->
                            <!--begin::Action-->
                            <a href="/salaries/{{ $salary->id }}/print" target="_blank" class="btn btn-sm btn-success"><i class="bi bi-printer"></i> Cetak</a>
                            <!--end::Action-->
                        </div>
                        <!--end::Top-->
                        <!--begin::Wrapper-->
                                            ...
                                            <tr v-for="(salaryItem, index) in salaryItems" class="fw-bolder text-gray-700 fs-5 text-end">
                                                ...
                                                <td v-if="salaryItem?.type == 'income'">
                                                    <div class="input-group input-group-sm mb-5">
                                                        ...
                                                        <input type="text" :value="salaryItem.amount" class="form-control text-end" readonly>
                                                    </div>
                                                </td>
                                                <td v-else>
...
<script>
    const salaryItems = <?php echo Illuminate\Support\Js::from([]) ?>;

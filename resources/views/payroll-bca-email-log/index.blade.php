...
@section('title', 'Log Email Payroll BCA')
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Cari Log" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
        ...
        <div class="card-body pt-0">
            ...
            <table class=" use-datatable table align-middle table-row-dashed fs-6" id="office_table">
                ...
                <tbody class="fw-bold text-gray-600 fs-7">
                    @foreach($logs as $log)
                    <tr>
                        <td class="ps-2">{{ $log->created_at }}</td>
                        <td>{{ $log->subject }}</td>
                        <td>{{ $log->content }}</td>
                        <td>
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    <p class="mb-0">{{ $log->transaction_file_name }}</p>
                                    <a href="{{ $log->transaction_file }}" target="_blank">
                                        Download <i class="bi bi-box-arrow-up-right text-primary"></i>
                                    </a>
                                </div>
                            </div>
                            @endif
                        ...
                        <td>
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    <p class="mb-0">{{ $log->checksum_file_name }}</p>
                                    <a href="{{ $log->checksum_file }}" target="_blank">
                                        Download <i class="bi bi-box-arrow-up-right text-primary"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <td><a href="/employees/{{ $log->createdByEmployee->id ?? '#' }}/detail" target="_blank">{{ $log->createdByEmployee->name ?? '#' }}</a></td>
                    </tr>
                    @endforeach
                </tbody>
                <!--end::Table body-->

                    ...
                    <div class="division-table">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <a href="/reports/attendances/all-export?company={{ $filter['company_id'] ?? '' }}&division={{ $filter['division_id'] ?? '' }}&start_date={{ $filter['start_date'] ?? '' }}&end_date={{ $filter['end_date'] ?? '' }}" class="btn btn-success" target="_blank"><i class="bi bi-download"></i> Download .xlsx</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-rounded border gy-7 gs-7">
                                <thead>
                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                                        ...
                                        <!-- --- -->
                                        <th class="min-w-200px">Jumlah Hari</th>
                                        <th class="min-w-200px">Hadir</th>
                                        <th class="min-w-200px">Telat (menit)</th>
                                        <th class="min-w-200px">Absen</th>
                                        <th class="min-w-200px">Sakit</th>
                                        <th class="min-w-200px">Cuti</th>
                                        <th class="min-w-200px">Sisa Cuti</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    const app = new Vue({
        ...
        methods: {
            applyFilter() {
                ...
                document.location.href = `/reports/attendances/all?company=${companyId}&division=${divisionId}&start_date=${startDate}&end_date=${endDate}`;
            },

                    ...
                    <div class="division-table">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <a href="/reports/salaries/thr-export?company={{ $filter['company_id'] }}&division={{ $filter['division_id'] }}&year={{ $filter['year'] }}" class="btn btn-success" target="_blank"><i class="bi bi-download"></i> Download</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-rounded border gy-7 gs-7">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ number_format($employee->thr, 0, ',', '.') }}</td>
                                    </tr>
                                    @endforeach
                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                                        <td colspan="6">Sub-Total</td>
                                        <td>{{ number_format($division->subtotal['thr'] ?? 0, 0, ',', '.') }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
    ...
    const app = new Vue({
        ...
        methods: {
            applyFilter() {
                ...
                document.location.href = `/reports/salaries/thr?company=${companyId}&division=${divisionId}&year=${year}`;
            }
        }
    })
</script>

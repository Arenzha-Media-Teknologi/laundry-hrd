...
@section('title', 'Laporan BPJS Ketenagakerjaan')
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-header">
                <div class="card-title">
                    <h2>Rekapitulasi BPJS Ketenagakerjaan</h2>
                </div>
                    ...
                    <div class="division-table">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <a href="/reports/insurances/bpjs-ketenagakerjaan-export?company={{ $filter['company_id'] ?? '' }}&division={{ $filter['division_id'] ?? '' }}&year={{ $filter['year'] ?? '' }}" class="btn btn-success" target="_blank"><i class="bi bi-download"></i> Download .xlsx</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-rounded border gy-7 gs-7">
                                <thead>
                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                                        ...
                                        <th colspan="4" class="min-w-200px text-center">Pembayaran Polis Tahun 2022</th>
                                        <th colspan="2" class="min-w-200px text-center">Akumulasi Nilai Polis Tahun 2022</th>
                                    </tr>
                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                                        <th class="min-w-200px text-end">JHT</th>
                                        <th class="min-w-200px text-end">JKK</th>
                                        <th class="min-w-200px text-end">JKM</th>
                                        <th class="min-w-200px text-end">JP</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">{{ number_format((int) $employee->current_year_value[$property] ?? 0, 0, ',', '.') }}</td>
                                        @endforeach
                                    </tr>
                                    @endforeach
                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
    ...
    const app = new Vue({
        ...
        methods: {
            applyFilter() {
                ...
                document.location.href = `/reports/insurances/bpjs-ketenagakerjaan?company=${companyId}&division=${divisionId}&year=${year}`;
            }
        }
    })
</script>

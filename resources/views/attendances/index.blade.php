        ...
        <div class="card-body pt-0">
            ...
            <div class="mb-5">
                <div class="d-flex align-items-center">
                    ...
                    <div class="me-3">
                        @foreach($filtered_company_name as $companyName)
                        <span class="badge badge-secondary">{{ $companyName }}</span>
                        @endforeach
                    </div>
                    <div class="me-3">
                        @foreach($filtered_division_name as $divisionName)
                        <span class="badge badge-secondary">{{ $divisionName }}</span>
                        @endforeach
                    </div>
                    <div class="me-3">
                        @foreach($filtered_office_name as $officeName)
                        <span class="badge badge-secondary">{{ $officeName }}</span>
                        @endforeach
                    </div>
                    <div class="me-3">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        <tr v-for="(employee, index) in employees" class="text-center">
                            ...
                            <template v-if="employee.attendances.length > 0">
                                <td>
                                    <div>
                                        <span class="badge text-uppercase" :class="badgeColor(employee.attendances[0])">
                                            <span>@{{ statusName(employee.attendances[0]) }}</span>
                                    ...
                                    <div v-cloak v-if="employee.attendances[0].is_permission == 1" class="mt-2">
                                        <span v-if="employee.attendances[0].permission_status == 'pending'" class="badge badge-light-warning"><span class="align-middle">@{{ employee.attendances[0].permission_category.name }} [@{{ employee.attendances[0].permission_note || "" }}] (Menunggu)</span> <i class="bi bi-clock text-warning align-middle"></i></span>
                                        <span v-else-if="employee.attendances[0].permission_status == 'approved'" class="badge badge-light-success"><span class="align-middle">@{{ employee.attendances[0].permission_category.name }} [@{{ employee.attendances[0].permission_note || "" }}] (Disetujui)</span> <i class="bi bi-check text-success align-middle"></i></span>
                                        <span v-else-if="employee.attendances[0].permission_status == 'rejected'" class="badge badge-light-danger"><span class="align-middle">@{{ employee.attendances[0].permission_category.name }} [@{{ employee.attendances[0].permission_note || "" }}] (Ditolak)</span> <i class="bi bi-x text-danger align-middle"></i></span>
                                    </div>
                                </td>
                                <!--end::Email=-->
                                <!--begin::Company=-->
                                <td class="text-center">
                                    <div class="fw-bolder text-gray-800">@{{ employee.attendances[0].clock_in_time || '' }}</div>
                                ...
                                <td class="text-center">
                                    <div class="fw-bolder text-gray-800">@{{ employee.attendances[0].clock_out_time || '' }}</div>
                                    <div class="d-flex align-items-center justify-content-center mx-2">
                                ...
                                <td>
                                    <div v-cloak v-if="employee.attendances[0].is_long_shift == 1">
                                        <!-- @{{ employee.attendances[0].long_shift_status }} -->
                                        <span v-if="employee.attendances[0].long_shift_status == 'pending'" class="badge badge-light-warning">Pending</span>
                                        <span v-else-if="employee.attendances[0].long_shift_status == 'approved'" class="badge badge-light-success">Disetujui (@{{ employee.attendances[0].long_shift_confirmer.name }} - @{{ employee.attendances[0].long_shift_confirmed_at }})</span>
                                        <span v-else-if="employee.attendances[0].long_shift_status == 'rejected'" class="badge badge-light-danger">Ditolak (@{{ employee.attendances[0].long_shift_confirmer.name }} - @{{ employee.attendances[0].long_shift_confirmed_at }})</span>
                                    </div>
                                </td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_division_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_division_header" data-kt-scroll-wrappers="#kt_modal_add_division_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="row mb-7">
                            <div class="fv-row col-md-6 fv-plugins-icon-container">
                                <label class="form-label">Long Shift</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" v-model="model.edit.isLongShift" id="longShiftCheck" checked />
                                    <label class="form-check-label" for="longShiftCheck">
                            ...
                            <div class="fv-row col-md-6">
                                <!--begin::Label-->
                                <label class="form-label">Status Long Shift</label>
                                <!--end::Label-->
                                <div class="form-check form-check-custom form-check-warning form-check-solid mb-3">
                                    <input class="form-check-input" v-model="model.edit.longShiftStatus" type="radio" value="pending" id="radioLongShiftStatusPending" :disabled="model.edit.isLongShift != 1" />
                                    <label class="form-check-label" for="radioLongShiftStatusPending">
                                        Pending
                                    </label>
                                </div>
                                <div class="form-check form-check-custom form-check-success form-check-solid mb-3">
                                    <input class="form-check-input" v-model="model.edit.longShiftStatus" type="radio" value="approved" id="radioLongShiftStatusApproved" :disabled="model.edit.isLongShift != 1" />
                                    <label class="form-check-label" for="radioLongShiftStatusApproved">
                                        Disetujui
                                    </label>
                                </div>
                                <div class="form-check form-check-custom form-check-danger form-check-solid">
                                    <input class="form-check-input" v-model="model.edit.longShiftStatus" type="radio" value="rejected" id="radioLongShiftStatusRejected" :disabled="model.edit.isLongShift != 1" />
                                    <label class="form-check-label" for="radioLongShiftStatusRejected">
                                        Ditolak
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_division_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_division_header" data-kt-scroll-wrappers="#kt_modal_add_division_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="row mb-7">
                            <div class="fv-row col-md-6 fv-plugins-icon-container">
                                <label class="form-label">Long Shift</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" v-model="model.add.isLongShift" id="longShiftCheck" checked />
                                    <label class="form-check-label" for="longShiftCheck">
                            ...
                            <div class="fv-row col-md-6">
                                ...
                                <!--end::Label-->
                                <div class="form-check form-check-custom form-check-warning form-check-solid mb-3">
                                    <input class="form-check-input" v-model="model.add.longShiftStatus" type="radio" value="pending" id="radioLongShiftStatusPending" :disabled="model.add.isLongShift != 1" />
                                    <label class="form-check-label" for="radioLongShiftStatusPending">
                                        Pending
                                    </label>
                                </div>
                                <div class="form-check form-check-custom form-check-success form-check-solid mb-3">
                                    <input class="form-check-input" v-model="model.add.longShiftStatus" type="radio" value="approved" id="radioLongShiftStatusApproved" :disabled="model.add.isLongShift != 1" />
                                    <label class="form-check-label" for="radioLongShiftStatusApproved">
                                        Disetujui
                                    </label>
                                </div>
                                <div class="form-check form-check-custom form-check-danger form-check-solid">
                                    <input class="form-check-input" v-model="model.add.longShiftStatus" type="radio" value="rejected" id="radioLongShiftStatusRejected" :disabled="model.add.isLongShift != 1" />
                                    <label class="form-check-label" for="radioLongShiftStatusRejected">
                                        Ditolak
                                    </label>
                                </div>
...
<script>
    ...
    const app = new Vue({
        ...
        computed: {
            ...
            filteredDivisions() {
                const companyIds = this.model.filter.companyId;
                if (Array.isArray(companyIds)) {
                    // console.log(this.divisions.filter(division => companyIds.includes(division.company_id)));
                    return this.divisions.map(division => {
                        division.company_id = division.company_id.toString();
                        return division;
                    }).filter(division => companyIds.includes(division.company_id));
                }
            ...
            filteredOffices() {
                const divisionIds = this.model.filter.divisionId;
                if (Array.isArray(divisionIds)) {
                    return this.offices.map(office => {
                        office.division_id = office.division_id.toString();
                        return office;
                    }).filter(office => divisionIds.includes(office.division_id));
                }
        ...
        methods: {
            ...
            async storeAttendance() {
                ...
                try {
                    ...
                    if (isLongShift == 1 && !longShiftStatus) {
                        toastr.warning("Isi status long shift");
                        return;
                    }
                    ...
                    const response = await axios.post('/attendances', {
                        ...
                        long_shift_status: longShiftStatus,
                    });
                ...
                if (employeeId) {
                    ...
                    if (employee) {
                        ...
                        if (attendance) {
                            ...
                            self.model.edit.isLongShift = attendance.is_long_shift;
                            self.model.edit.longShiftStatus = attendance.long_shift_status;
                        }
                    }
                }
            },
        ...
        watch: {
            'model.add.isLongShift': function(newValue, oldValue) {
                if (newValue != 1) {
                    this.model.add.longShiftStatus = "";
                }
            },
            'model.edit.isLongShift': function(newValue, oldValue) {
                if (newValue != 1) {
                    this.model.edit.longShiftStatus = "";
                }
            },
        }
    })

    const selectFilterCompany = $('#select-filter-company').select2();
    $('#select-filter-company').on('change', function() {
        // console.log($(this).val())
        app.$data.model.filter.companyId = $(this).val();
    });

    const companyIds = app.$data.model.filter.companyId.split(',');

    if (Array.isArray(companyIds)) {
        $('#select-filter-company').val(companyIds).trigger('change');
    }

    const selectFilterDivision = $('#select-filter-division').select2();
    $('#select-filter-division').on('change', function() {
        app.$data.model.filter.divisionId = $(this).val();
    });

    const divisionIds = app.$data.model.filter.divisionId.split(',');

    if (Array.isArray(divisionIds)) {
        $('#select-filter-division').val(divisionIds).trigger('change');
    }

    const selectFilterOffice = $('#select-filter-office').select2();
    $('#select-filter-office').on('change', function() {
        app.$data.model.filter.officeId = $(this).val();
    });

    const officeIds = app.$data.model.filter.officeId.split(',');

    if (Array.isArray(officeIds)) {
        $('#select-filter-office').val(officeIds).trigger('change');
    }

    console.log(selectFilterCompany);

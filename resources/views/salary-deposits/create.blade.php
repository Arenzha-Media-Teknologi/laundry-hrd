...
<script>
    ...
    Vue.component('my-currency-input', {
        ...
        template: `
            ...
            <input type="text" class="form-control form-control-sm" v-model="displayValue" @blur="isInputActive = false" @focus="isInputActive = true"/>
            ...
            async onSubmit() {
                ...
                try {
                    ...
                    if (response) {
                        ...
                        setTimeout(() => {
                            document.location.href = '/salary-deposits';
                        }, 500);
                    }
                } catch (error) {

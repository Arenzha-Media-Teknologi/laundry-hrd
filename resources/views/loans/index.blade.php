            ...
            <table class="use-datatable table align-middle table-row-dashed fs-6" id="office_table">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-gray-600">{{ $loan->effective_date }}</span>
                        </td>
                        <td class="text-end">
                            <span class="text-gray-800">
                        ...
                        <td class="text-end pe-2">
                            <div class="d-flex justify-content-end">
                                ...
                                @endcan
                                @can('update', App\Models\Loan::class)
                                <!--begin::Share link-->
                                ...
                                @endcan
                                @can('delete', App\Models\Loan::class)
...
<script>
    ...
    $(function() {
        ...
        $('#office_table').on('click', '.btn-delete', function() {
            // console.log('clicked');

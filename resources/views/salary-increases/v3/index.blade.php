            ...
            <div class="card-body pt-0">
                <div class="d-flex flex-column gap-10">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-striped table-row-bordered fs-6" id="salary-increases-datatable">
                            <!--begin::Table head-->
                            <thead style="background-color: #186599;">
                                ...
                                <tr class="text-start text-white fw-bolder fs-7 text-uppercase gs-0 align-middle">
                                    ...
                                    <th class="text-center" colspan="4">Saat Ini ({{ $filter["year"] - 1 }})</th>
                            ...
                            <tbody class="text-gray-600">
                                ...
                                <tr v-for="(employee, index) in employeesByDivision" :key="employee.id">
                                    <!--begin::Category=-->
                                    <td>
                                        <div>
                                            <div class="text-gray-800 text-hover-primary fs-6 fw-bold mb-1">@{{ employee.name }}</div>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            applyFilter() {
                ...
                const url = `/salary-increases?company=${companyId}&division=${divisionId}&year=${year}&staff_only=${staffOnly}`;

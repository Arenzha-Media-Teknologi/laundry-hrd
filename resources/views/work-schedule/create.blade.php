...
@section('title', 'Buat Jadwal Kerja')
...
<div id="kt_content_container" class="container-xxl" style="margin-top: -30px;">
    ...
    <div>
        <h1 class="mb-0">Buat Jadwal Kerja</h1>
        <p class="text-muted mb-0">Buat Jadwal Kerja Pegawai</p>
    </div>
    ...
    <div class="card mb-5 mb-xxl-10">
        ...
        <div class="card-header">
            <div class="card-title">
                <h3>Pilih Tanggal Jadwal Kerja</h3>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
        <div class="card-body pb-0">
            ...
            <div v-if="visibleAlert" v-cloak class="alert bg-light-warning d-flex flex-column flex-sm-row align-items-center w-100 p-5 mb-10">
                ...
                <div class="d-flex flex-column pe-0 pe-sm-10">
                    <span class="text-gray-700 fs-6">Pilih tanggal dan tekan tombol "Generate" untuk melihat jadwal</span>
                </div>
                <!--end::Content-->
            </div>
            <!--end::Alert-->
            <div class="row align-items-end mb-6">
                <div class="col-md-4">
                    <div class="mb-0">
                        ...
                        <input class="form-control form-control-solid" placeholder="Pilih tanggal" id="date-range-picker" autocomplete="off" />
                    </div>
                </div>
                <div class="col-md-2">

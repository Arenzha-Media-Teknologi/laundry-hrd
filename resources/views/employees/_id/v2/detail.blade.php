...
<div id="kt_content_container" class="container-xxl">
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-header">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">General</h3>
            </div>
            <!--end::Card title-->
            <!--begin::Action-->
            <a href="/employees/{{ $employee->id }}/edit-v2" class="btn btn-light-primary align-self-center">Ubah Data Pegawai</a>
            <!--end::Action-->
        </div>
        <!--begin::Card header-->
        <!--begin::Card body-->
        <div class="card-body p-9">
            ...
            <div class="mb-7">
                ...
                <span class="fw-bold fs-6 text-gray-800">{{ $employee->activeCareer->jobTitle->name ?? '' }}&nbsp;-&nbsp;{{ $employee->activeCareer->jobTitle->designation->name ?? '' }}&nbsp;-&nbsp;{{ $employee->activeCareer->jobTitle->designation->department->name ?? '' }}</span>
            </div>
            <div class="mb-7">
                <i class="bi bi-calendar-check me-1"></i>
                <span class="fw-bold fs-6 text-gray-800">{{ $employee->place_of_birth }}, {{ \Carbon\Carbon::parse($employee->date_of_birth)->isoFormat('LL') }}, {{ \Carbon\Carbon::now()->diffInYears($employee->date_of_birth) }} Tahun</span>
            </div>
            <div class="mb-7">
                <i class="bi bi-geo-alt me-1"></i>
                <span class="fw-bold fs-6 text-gray-800">{{ $employee->address }}</span>
            </div>
            <div class="mb-7">
                <div class="d-flex">
                    <div class="me-10">
                    ...
                    <div>
                        ...
                        <span class="fw-bold fs-6 text-gray-800">{{ $employee->phone }}</span>
                    </div>
                </div>
            </div>
            <div class="mb-7">
                <div class="d-flex">
                    <div class="me-10">
                        ...
                        <span class="fw-bold fs-6 text-gray-800"><span class="text-gray-600">KTP #</span> {{ $employee->identity_number }}</span>
                    </div>
                    <div>
                        <i class="bi bi-card-list me-1"></i>
                        <span class="fw-bold fs-6 text-gray-800"><span class="text-gray-600">NPWP #</span> {{ $employee->npwp_number }}</span>
                    </div>
                </div>
            </div>
            <div class="mb-7">
                <i class="bi bi-building me-1"></i>
                <span class="fw-bold fs-6 text-gray-800"><span class="text-uppercase">{{ $employee->recent_education }}</span> - {{ $employee->education_institution_name }}</span>
            </div>
            <h3 class="mb-7">SIM</h3>
            @foreach($employee->driversLicenses as $driversLicense)
            <div class="mb-7">
                <i class="bi bi-card-list me-1"></i>
                <span class="fw-bold fs-6 text-gray-800"><span class="text-gray-600">SIM <span class="text-uppercase">{{ $driversLicense->type }}</span> # </span>{{ $driversLicense->number }} - Exp. Date {{ \Carbon\Carbon::parse($driversLicense->expire_date)->isoFormat('LL')  }}</span>
            </div>
            @endforeach
            <h3 class="mb-7">Kontak Darurat</h3>
            <div class="mb-7">
                <i class="bi bi-person me-1"></i>
                <span class="fw-bold fs-6 text-gray-800">{{ $employee->emergency_contact_name }} - <span class="text-gray-600">HP #</span> {{ $employee->emergency_contact_phone }} - {{ $employee->emergency_contact_relation }}</span>
            </div>
        </div>
        <!--end::Card body-->
    </div>
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-header">
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Penggajian</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-3 fw-bold text-muted">Gaji Pokok</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($salary_values['gaji_pokok'], 0, ',', '.') }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            ...
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-3 fw-bold text-muted">Tunjangan</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($salary_values['tunjangan'], 0, ',', '.') }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            ...
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-3 fw-bold text-muted">Uang Harian</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($salary_values['uang_harian'], 0, ',', '.') }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            ...
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-3 fw-bold text-muted">Lembur</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($salary_values['lembur'], 0, ',', '.') }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            <h3 class="mb-7">Asuransi</h3>
            @if(count($employee->privateInsurances) == 0)
            <p class="text-muted my-5 fw-bold"><em>Tidak ada asuransi</em></p>
            @endif
            @foreach($employee->privateInsurances as $index => $employeePrivateInsurance)
            <div>
                <div class="mb-8">
                    <span class="fw-bold fs-6 text-gray-800">
                        <span class="me-15">{{ $employeePrivateInsurance->name }}</span>
                        <span class="me-15">#{{ $employeePrivateInsurance->pivot->number ?? '' }}</span>
                        <span>
                            <span class="text-gray-600">Tahun Mulai Polis: &nbsp;</span>
                            {{ $employeePrivateInsurance->pivot->start_year ?? '' }}
                        </span>
                    </span>
                </div>
                <div class="row mb-7">
                    <!--begin::Label-->
                    <label class="col-lg-3 fw-bold text-muted">Total Premi</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($employeePrivateInsurance->values[0]->total_premi ?? 0, 0, ',', '.') }}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-7">
                    <!--begin::Label-->
                    <label class="col-lg-3 fw-bold text-muted">Premi Kesehatan</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($employeePrivateInsurance->values[0]->kesehatan ?? 0, 0, ',', '.') }}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-7">
                    <!--begin::Label-->
                    <label class="col-lg-3 fw-bold text-muted">Premi Tabungan</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($employeePrivateInsurance->premi_tabungan, 0, ',', '.') }}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-7">
                    <!--begin::Label-->
                    <label class="col-lg-3 fw-bold text-muted">Premi Kematian</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($employeePrivateInsurance->premi_kematian, 0, ',', '.') }}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-7">
                    <!--begin::Label-->
                    <label class="col-lg-3 fw-bold text-muted">Nilai Tunai</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bolder fs-6 text-gray-800">Rp {{ number_format($employeePrivateInsurance->values[0]->nilai_tabungan ?? 0, 0, ',', '.') }}</span>
                    </div>
                    <!--end::Col-->
                </div>
            </div>
            @if ($index < (count($employee->privateInsurances) - 1))
                <div class="separator mb-7">
                </div>
                @endif
                @endforeach
        </div>

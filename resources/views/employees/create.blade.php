        ...
        <div class=" d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body text-center pt-0">
                    <!--begin::Image input-->
                    <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(<?= asset('assets/media/svg/avatars/blank.svg') ?>)" id="employee_photo">
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="text-end">
                            <div class="d-flex align-items-center text-end justify-content-end">
                                <a data-bs-toggle="collapse" href="#collapseAddonForm" role="button" aria-expanded="false" aria-controls="collapseAddonForm"><strong>Informasi Tambahan & NPWP&nbsp;</a></strong>
                    ...
                    <div class="collapse" id="collapseAddonForm">
                        ...
                        <div class="d-flex flex-wrap gap-5 mb-6">
                            ...
                            <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                                <!--begin::Label-->
                                <label class="form-label">Tanggal Mulai NPWP</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="date" v-model="model.npwp.effectiveDate" class="form-control form-control-sm">
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex flex-wrap gap-5 mb-6">
                        ...
                        <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                            ...
                            <input type="number" v-model="model.salary.gaji_pokok" class="form-control form-control-sm mb-2" placeholder="0" />

                            <div class="text-muted fs-7">Masukkan nominal gaji pokok</div>
                        ...
                        <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                            ...
                            <input type="number" v-model="model.salary.tunjangan" class="form-control form-control-sm mb-2" placeholder="0" />

                            <div class="text-muted fs-7">Masukkan nominal tunjangan</div>
                    ...
                    <div class="d-flex flex-wrap gap-5 mb-6">
                        ...
                        <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                            ...
                            <input type="number" v-model="model.salary.uang_harian" class="form-control form-control-sm mb-2" placeholder="0" />

                            <div class="text-muted fs-7">Masukkan nominal uang harian</div>
                        ...
                        <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                            ...
                            <input type="number" v-model="model.salary.lembur" class="form-control form-control-sm mb-2" placeholder="0" />

                            <div class="text-muted fs-7">Masukkan nominal lembur per jam</div>
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-6 fv-row">
                        <!--begin::Label-->
                        <label class="required form-label">Departemen</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        ...
                        <!--end::Input-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7 text-end"><a href="/structures" target="_blank">Tambah Departemen</a></div>
                        <!--end::Description-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="mb-6 fv-row">
                        ...
                        <!--begin::Description-->
                        <div class="text-muted fs-7 d-flex justify-content-between align-items-center">
                            <span><em v-cloak v-if="!model.departmentId">Pilih departemen</em></span>
                            <a href="/structures" target="_blank">Tambah Bagian</a>
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="mb-6 fv-row">
                        ...
                        <!--begin::Description-->
                        <div class="text-muted fs-7 d-flex justify-content-between align-items-center">
                            <span><em v-cloak v-if="!model.jobTitleId">Pilih bagian</em></span>
                            <a href="/structures" target="_blank">Tambah Job Title</a>
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Input group-->

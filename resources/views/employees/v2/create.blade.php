                    ...
                    <div class="row mb-8">
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="email" v-model="model.email" class="form-control form-control-sm mb-2" placeholder="Masukkan email" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-8">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(<?= asset('assets/media/svg/files/blank-image.svg') ?>)" id="ktp_photo">
                                        <!--begin::Preview existing avatar-->
                                        <div class="image-input-wrapper w-150px h-150px"></div>
                                        <!--end::Preview existing avatar-->
                                        <!--begin::Label-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-4"></div>
                                <div class="col-md-8">
                                    <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(<?= asset('assets/media/svg/files/blank-image.svg') ?>)" id="npwp_photo">
                                        <!--begin::Preview existing avatar-->
                                        <div class="image-input-wrapper w-150px h-150px"></div>
                                        <!--end::Preview existing avatar-->
                                        <!--begin::Label-->
                                        ...
                                        <div class="col-lg-4">
                                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(<?= asset('assets/media/svg/files/blank-image.svg') ?>)">
                                                ...
                                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Ubah">
                                                    ...
                                                    <!--end::Icon-->
                                                    <!--begin::Inputs-->
                                                    <input type="file" ref="image" name="avatar" accept=".png, .jpg, .jpeg" @change="handleDriversLicenseImage($event, index)" />
                                                    <input type="hidden" name="avatar_remove" />
                                                    <!--end::Inputs-->
                                                </label>
                                                <!--end::Label-->
            ...
            return {
                ...
                model: {
                    ...
                    salary: {
                        ...
                        uang_makan: 0,
                        tunjangan_harian: 0,
                        magenta_daily_salary: false,
                        aerplus_daily_salary: false,
                    },
                    driversLicenses: [],
                    insuranceType: '',
                    insurances: [],

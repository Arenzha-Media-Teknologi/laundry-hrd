        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h1 class="text-white mb-3 fs-2x">Gaji Bulanan</h1>
                ...
                <div class="text-end">
                    ...
                    <p class="text-white fs-2x m-0">Rp @{{ currencyFormat(fixSalaries.totalTakeHomePay + generatedSalaries.totalTakeHomePay) }}</p>
                </div>
            </div>
        </div>
    </div>
    <div class="card mb-5 mb-xxl-10" id="cardRunPayroll">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-secondary" role="alert">
                ...
                <span>Pilih bulan, tahun, dan perusahaan kemudian klik tombol <strong>Generate</strong> untuk men-<em>generate</em> file</span>
            </div>
            ...
            <div class="d-flex flex-column flex-grow-1 gap-7 my-4 my-8" data-kt-scroll="true">
                <div class="d-flex align-items-center position-relative">
                    ...
                    <div class="card border border-dashed d-flex flex-column p-6 gap-5 flex-grow-1 mb-2">
                        ...
                        @endif
                        <div>
                            <a href="/payroll-bca/monthly/multi-payroll-template?start_date_period={{ $start_date }}&end_date_period={{ $end_date }}&staff_only={{ $staff_only }}&company_id={{ $company_id }}" class="btn btn-outline btn-sm btn-outline-success btn-active-light-success" target="_blank">
    ...
    const app = new Vue({
        ...
        computed: {
            downloadTransactionTxtUrl() {
                ...
                return `/payroll-bca/monthly/export-transaction-txt?start_date_period={{ $start_date }}&end_date_period={{ $end_date }}&staff_only={{ $staff_only }}&company_id={{ $company_id }}&header_id=${headerId}&effective_date=${effectiveDate}&effective_time=${effectiveTime}&remark=${remark}`;
            },
        },
        methods: {
            ...
            async generate() {
                ...
                document.location.href = `/payroll-bca/monthly?month=${month}&year=${year}&staff_only=${staffOnly}&company_id=${companyId}`;
            },

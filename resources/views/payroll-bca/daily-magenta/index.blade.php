        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h1 class="text-white mb-3 fs-2x">Gaji Harian Magenta</h1>
            ...
            <div class="d-flex flex-column flex-grow-1 gap-7 my-4 my-8" data-kt-scroll="true">
                <div class="d-flex align-items-center position-relative">
                    ...
                    <div class="card border border-dashed d-flex flex-column p-6 gap-5 flex-grow-1 mb-2">
                        ...
                        @endif
                        <div>
                            <a href="/payroll-bca/daily-magenta/multi-payroll-template?start_date_period={{ $start_date }}&end_date_period={{ $end_date }}&company_id={{ $company_id }}" class="btn btn-outline btn-sm btn-outline-success btn-active-light-success" target="_blank">
    ...
    const app = new Vue({
        ...
        computed: {
            downloadTransactionTxtUrl() {
                ...
                return `/payroll-bca/daily-magenta/export-transaction-txt?start_date_period={{ $start_date }}&end_date_period={{ $end_date }}&company_id={{ $company_id }}&header_id=${headerId}&effective_date=${effectiveDate}&effective_time=${effectiveTime}&remark=${remark}`;
            },
            periodsByYear() {
                const self = this;
        ...
        methods: {
            ...
            async generate() {
                ...
                document.location.href = `/payroll-bca/daily-magenta?start_date=${startDate}&end_date=${endDate}`;
            },

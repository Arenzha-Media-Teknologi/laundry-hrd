        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                <div class="d-flex flex-column gap-10">
                    <div class="d-flex flex-wrap fw-bold mb-4 fs-5 text-gray-400">Masukkan nilai gaji pegawai untuk gaji pokok dan tunjangan</div>
                    <!--begin::Input group-->
                        ...
                        <table class="table align-middle table-striped table-row-bordered fs-6 gy-5" id="salary-increases-datatable">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center" colspan="10">Nilai Gaji</th>
                            ...
                            <tbody class="text-gray-600">
                                ...
                                <tr v-cloak v-else v-for="(employee, index) in employeesByDivision" :key="employee.id">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control text-end form-control-sm" v-cleave="cleave.thousandFormat">
                                    </td>
                                    <!--end::gaji Pokok-->
                            ...
                            <tfoot>
                                <tr>
                                    <td>Total</td>
                                    <td></td>
                                    <td class="text-end fs-5 text-primary">@{{ currencyFormat(totalAll.totalBasicSalaryAddition) }}</td>
                                    <td></td>
                                    <td class="text-end fs-5 text-primary">@{{ currencyFormat(totalAll.totalAllowanceAddition) }}</td>
                                    <td></td>
                                    <td class="text-end fs-5 text-primary">@{{ currencyFormat(totalAll.totalDailyMoneyAddition) }}</td>
                                    <td></td>
                                    <td class="text-end fs-5 text-primary">@{{ currencyFormat(totalAll.totalOvertimeAddition) }}</td>
                                    <td></td>
                                    <td class="text-end fs-5 text-primary">@{{ currencyFormat(totalAll.totalBonusAddition) }}</td>
                                    <td></td>
                                    <td colspan="5"></td>
                                </tr>
                            </tfoot>

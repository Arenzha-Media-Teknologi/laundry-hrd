    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                model: {
                    id: Number('{{ $office?->id }}'),
                    companyId: Number('{{ $office?->division?->company_id }}'),
                    divisionId: Number('{{ $office?->division_id }}'),
                    name: '{{ $office?->name }}',
                    phone: '{{ $office?->phone }}',
                    address: <?php echo Illuminate\Support\Js::from($office->address) ?>,
                    openingTime: '{{ $office?->opening_time }}',
        ...
        methods: {
            ...
            async onSubmit() {
                ...
                try {
                    ...
                    const response = await axios.post(`/offices/${self.model.id}`, {

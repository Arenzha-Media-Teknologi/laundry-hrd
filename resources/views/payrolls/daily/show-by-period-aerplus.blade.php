            ...
            sendBulkDeleteRequest() {
                ...
                return axios.delete('/daily-salaries/action/bulk-delete' + '?ids=' + JSON.stringify(self?.salariesIds.map(id => Number(id))))
                    .then(async function(response) {
                        ...
                        const response2 = axios.delete(`{{ env("OPERATIONAL_URL") }}/api/v1/outlet-spendings/delete-from-payment-batch-code?payment_batch_code=${JSON.stringify(paymentBatchCodes)}`);
          ...
          `,
            ...
            async sendPayment(date) {
                ...
                try {
                    ...
                    const response = await axios.post('{{ env("OPERATIONAL_URL") }}/api/v1/outlet-spendings', {

                        ...
                        <div class="row justify-content-end mt-10">
                            <div class="col-md-4">
                                <div class="d-flex justify-content-between mb-5">
                                    ...
                                    <h5 class="mb-0 text-gray-800">Rp @{{ currencyFormat(selectedDetailSalary?.summary?.total_incomes) }}</h5>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-0 text-gray-700">Potongan</h5>
                                    <h5 class="mb-0 text-gray-800">(Rp @{{ currencyFormat(selectedDetailSalary?.summary?.total_deductions) }})</h5>
                                </div>
                                ...
                                <div class="d-flex justify-content-between my-3 bg-light-success p-5 border-success border-bottom-dashed border-top-dashed">
                                    ...
                                    <h3 class="mb-0 text-gray-800">Rp @{{ currencyFormat(selectedDetailSalary.summary.take_home_pay) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>

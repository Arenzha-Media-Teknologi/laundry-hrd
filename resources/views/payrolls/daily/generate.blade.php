        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" v-model="model.searchKeyword" employee-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Cari Pegawai" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed" id="employee_table">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    <tr v-cloak v-for="(salary, index) in filteredSalaries">
                        <td class="ps-2">
                            <div class="form-check form-check-custom">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr v-for="(salary, index) in selectedDetailSalary.periods" class="fw-bold fs-6 text-gray-700">
                                        ...
                                        <td class="text-end text-gray-700 pe-2">@{{ currencyFormat(Number(salary.total)) }}</td>
                                    </tr>
                                </tbody>
        ...
        computed: {
            filteredSalaries() {
                return this.salaries.filter(salary => {
                    return (salary?.employee?.name ?? '').toLowerCase().includes(this.model.searchKeyword.toLowerCase());
                });
            },
            visibleAlert() {
